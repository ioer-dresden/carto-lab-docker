...
| Python (Server)                                  | 3.10.10   | 3.12.5    | 3.12.7      | 3.12.10      | 3.14.0      |
| Python (worker_env)                              | 3.9.15    | 3.12.5    | 3.12.7      | 3.13.3       | 3.12.11     |
| notebook                                         | 6.5.3     | 6.5.7     |             |              |             |
| IPython                                          | 8.12.0    | 8.26.0    | 8.29.0      | 9.2.0        | 9.6.0       |
| nodejs                                           | /         |           | 22.11.0     | 22.13.0      | 24.9.0      |
| Language Server: jupyterlab-lsp                  | /         |           | 5.1.0 (x)   |              | 5.2.0       |
| Language Server:  pyright                        | /         |           | 1.1.389 (x) | 1.1.400      | 1.1.406     |
...
| matplotlib                                       | 3.7.1     | 3.9.2     |             | 3.10.1       | 3.10.6      |
| shapely                                          | 1.7.1     | 2.0.6     |             | 2.1.0        | 2.1.2       |
| pyproj                                           | 3.2.1     | 3.6.1     | 3.7.0       | 3.7.1        | 3.7.2       |
| pandas                                           | 1.5.3     | 2.2.2     | 2.2.3       |              | 2.3.3       |
| numpy                                            | 1.22.4    | 1.26.4    |             | 2.2.5        | 2.3.3       |
| cartopy                                          | 0.20.1    | 0.23.0    | 0.24.0      |              | 0.25.0      |
| geoviews                                         | 1.9.5     | 1.12.0    | 1.13.0      | 1.14.0       | 1.14.1      |
| Bokeh                                            | 2.4.3     | 3.4.2     | 3.5.2       | 3.7.2        | 3.8.0       |
