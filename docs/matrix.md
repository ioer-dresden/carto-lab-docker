...
| ▼Feature or Package - Carto-Lab Docker Version ▶ | 0.13.0    | 0.19.0    | 0.24.2      | 0.27.0       |
| ------------------------------------------------ | --------- | --------- | ----------- | ------------ |
| Container OS                                     | Debian 11 | Debian 12 |             |              |
| Conda                                            | 23.3.1    | 24.7.1    | 24.11.0     | 25.3.1       |
| Jupyter Lab                                      | 3.6.3     | 4.2.5     | 4.3.1       | 4.4.0 (x)    |
...
To extract versions during development, modify your `.env` and add:
```
COMPOSE_FILE=docker-compose.build.yml
```

Then use `bash tests/get_versions.sh`, which will output versions from your locally built Docker container.
